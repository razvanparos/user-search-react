...
function Home() {
    ...
    const [userEndpoint, setUserEndpoint] = useState('octocat');
    ...
    useEffect(()=>{
      ...
      }else document.body.style.backgroundColor = "#141d2f";
    ...
    <div className={`home-div ${theme?'':'dark-theme'}`}>
      ...
      <div className='search-bar-div'>
        <div className='search-logo-input'>
          ...
          <input type="text" value={userSearch} className={`search-input ${theme?'':'dark-theme'}`} placeholder='Search GitHub username...' onChange={handleSearchChange}/>
        </div>
      ...
      {userData && (
        <div className='main-div'> 
            ...
            <div className='user-details-top'>
                <p className={`user-name ${theme?'':'dark-theme'}`}>{userData.name}</p>
            ...
            <div className='user-stats-div'>
                <div className='stat'>
                    <p>Repos</p>
                    <span className={`${theme?'':'dark-theme'}`}>{userData.public_repos}</span>
                </div>
                <div className='stat'>
                    <p>Followers</p>
                    <span className={`${theme?'':'dark-theme'}`}>{userData.followers}</span>
                </div>
                <div className='stat'>
                    <p>Following</p>
                    <span className={`${theme?'':'dark-theme'}`}>{userData.following}</span>
                </div>
            </div>
            <div className='user-details-bottom'>
                <div className='detail'>
                  <svg height="20" width="14" xmlns="http://www.w3.org/2000/svg" className="user-link-icon">
                ...
                <div className='detail'>
                  <svg height="18" width="20" xmlns="http://www.w3.org/2000/svg" className="user-link-icon">
